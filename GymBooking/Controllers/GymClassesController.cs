...
namespace GymBooking.Controllers
{
    ...
    public class GymClassesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StartTime,Duration,Description")] GymClass gymClass)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StartTime,Duration,Description")] GymClass gymClass)
        {
            if (ModelState.IsValid)
            {
